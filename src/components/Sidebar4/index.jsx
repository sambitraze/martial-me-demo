    ...
    <>
      <Sidebar className={props.className}>
        ...
        >
          ...
          >
            <Text>Contact</Text>
            <Button className="bg-pink-400 cursor-pointer font-bold font-cairo leading-[normal] min-w-[63px] my-[7px] py-1 rounded-[17px] text-center text-sm text-white-A700">
              NEW
            </Button>
