    ...
    <>
      <Sidebar className={props.className}>
        ...
        <Menu
          ...
          className="flex flex-col items-center justify-start mt-1 pt-2 w-full"
        >
          ...
          <div className="sm:h-48 md:h-[154px] h-[178px] mt-3.5 relative w-full">
            <MenuItem
              icon={
                <Img
                  className="h-7 w-7"
                  src="images/img_comment1_deep_purple_600.svg"
                  alt="commentOne"
                />
              }
            ...
            <div className="bg-gray-900_01 flex md:flex-col flex-row md:gap-5 h-full items-center justify-start w-full">
              <Img className="h-7" src="images/img_grid.svg" alt="grid_One" />
              <Text>Kanban</Text>
              <Img
                className="h-6 w-[345px]"
                src="images/img_arrowright_blue_gray_700.svg"
                alt="arrowright"
              />
            </div>
            <div className="absolute flex flex-col md:gap-10 gap-[78px] h-full inset-[0] items-center justify-center m-auto w-full">
              <Line className="bg-deep_purple-600 h-[50px] rounded-[3px] w-full" />
              <MenuItem
                icon={
                  <Img
                    className="h-7 w-7"
          ...
          <div className="flex flex-col items-center justify-end mt-3.5 w-full">
            <MenuItem
              icon={
                <Img
                  className="h-7 w-7"
        ...
        <Text
          className="mb-[1028px] ml-12 md:ml-[0] mr-[52px] mt-1.5 text-blue_gray-700 text-sm w-[72%] sm:w-full"
